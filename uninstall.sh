...
uninstall "$XDG_CONFIG_HOME/kitty/kitty.conf"
uninstall "$XDG_CONFIG_HOME/lf/cleaner"
uninstall "$XDG_CONFIG_HOME/lf/lfrc"
uninstall "$XDG_CONFIG_HOME/lf/preview"
...
uninstall "$HOME/.local/bin/lfrun"
